...
export const RECIPES: Recipe[] = [
  {
    ...
    ingredients: ['poha', 'onion', 'green chillies', 'curry leaves', 'turmeric', 'salt', 'lemon juice', 'oil', 'mustard seeds', 'coriander leaves'],
    dietaryType: 'vegan',
    cookTime: '15 min',
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['besan', 'onion', 'green chillies', 'coriander leaves', 'turmeric', 'cumin', 'salt', 'water', 'oil'],
    dietaryType: 'vegan',
    cookTime: '20 min',
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['rice', 'peas', 'carrot', 'beans', 'onion', 'ginger', 'garlic', 'garam masala', 'turmeric', 'salt', 'oil', 'water'],
    dietaryType: 'vegan',
    cookTime: '30 min',
    servings: 3,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['eggs', 'onion', 'tomato', 'turmeric', 'chilli powder', 'salt', 'oil', 'coriander leaves'],
    dietaryType: 'non-veg',
    cookTime: '15 min',
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['rava', 'mustard seeds', 'curry leaves', 'green chilli', 'onion', 'salt', 'water', 'oil', 'coriander leaves'],
    dietaryType: 'vegan',
    cookTime: '20 min',
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['cooked rice', 'onion', 'tomato', 'ginger garlic paste', 'turmeric', 'chilli powder', 'coriander leaves', 'lemon juice', 'oil', 'salt'],
    dietaryType: 'vegan',
    cookTime: '15 min',
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['boiled chickpeas', 'onion', 'tomato', 'cucumber', 'lemon juice', 'chaat masala', 'salt', 'coriander leaves', 'green chilli'],
    dietaryType: 'vegan',
    cookTime: '10 min',
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['toor dal', 'garlic', 'cumin seeds', 'hing', 'dry red chilli', 'tomato', 'turmeric', 'ghee', 'salt', 'coriander leaves'],
    dietaryType: 'veg',
    cookTime: '30 min',
    servings: 3,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    ingredients: ['potato', 'green chutney', 'tamarind chutney', 'yogurt', 'onion', 'sev', 'chaat masala', 'cumin powder', 'salt', 'oil', 'coriander leaves'],
    dietaryType: 'veg',
    cookTime: '30 min',
    servings: 3,
    difficulty: 'Medium',
  ...
  },
  {
    ...
    ingredients: ['potato', 'cauliflower', 'carrot', 'peas', 'onion', 'garlic', 'tomato', 'pav bhaji masala', 'butter', 'pav buns', 'lemon', 'coriander leaves', 'salt'],
    dietaryType: 'veg',
    cookTime: '40 min',
    servings: 4,
    difficulty: 'Medium',
  ...
  },
  {
    ...
    ingredients: ['wheat flour', 'potato', 'onion', 'green chilli', 'cumin', 'coriander leaves', 'salt', 'butter', 'oil', 'water'],
    dietaryType: 'veg',
    cookTime: '35 min',
    servings: 3,
    difficulty: 'Medium',
  ...
  },
  {
    ...
    ingredients: ['rice', 'moong dal', 'ghee', 'cumin seeds', 'turmeric', 'ginger', 'salt', 'water', 'coriander leaves'],
    dietaryType: 'veg',
    cookTime: '25 min',
    servings: 3,
    difficulty: 'Easy',
...
export function matchRecipes(userIngredients: string[]): Recipe[] {
  ...
  const scored = RECIPES.map((recipe) => {
    ...
    const percentage = Math.round((matchCount / recipeIngredients.length) * 100);
    return { recipe: { ...recipe, matchPercentage: percentage }, percentage };
  });
